            ...
            element.Conteudo.forEach(nomedoficheiro => {
                ...
                switch (teste) {
                    case TypeExtensionEnum.jpg:
                        $("#DivParent_" + element.id).append("<i class='fas fa-images'></i><div class='col-12 col-md-6'> <img style='margin-bottom: 50px; width: 100%;' src='../Files/FilesSended/" + nomedoficheiro + "' alt='" + element.nome + " image'> </div>");
                        break;
                    ...
                    case TypeExtensionEnum.mp4:
                        $("#DivParent_" + element.id).append("<i class='fas fa-film'></i><video class='col-12 col-md-6' style='margin-bottom: 50px; width: 100%;' controls><source src='../Files/FilesSended/" + nomedoficheiro + "' type='video/mp4'></video>");
                        break;
                    case TypeExtensionEnum.xlsx:
                        $("#DivParent_" + element.id).append("<i class='fas fa-link'></i><a class='' style='margin-bottom: 50px; width: 100%;' href='../Files/FilesSended/" + nomedoficheiro + "'>Link para o Excell</a>");
                        break;
                    default:
                        $("#DivParent_" + element.id).append("<i class='fas fa-link'></i><a class='' style='margin-bottom: 50px; width: 100%;' href='../Files/FilesSended/" + nomedoficheiro + "'>Link para o Ficheiro</a>");
                }
            });
